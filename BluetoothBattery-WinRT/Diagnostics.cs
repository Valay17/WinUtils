...
internal static class Diagnostics
{
    ...
    // Logging is off unless a file named logging.on sits beside the executable.
    ...
    internal static void WriteDeviceDump(IEnumerable<DeviceInformation> devices, IEnumerable<DeviceView> known)
    {
        ...
        report.AppendLine();
        report.AppendLine("== Raw properties reported by Windows (WinRT) ==");
        report.AppendLine("Battery is expected to be null here for classic devices - WinRT does");
        report.AppendLine("not expose it. This section is for everything else.");
        report.AppendLine();
        ...
        foreach (var device in devices)
        {
            ...
            report.AppendLine($"    Enabled : {device.IsEnabled}");
