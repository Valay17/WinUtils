...
internal static class BatteryIcon
{
    ...
    internal static IntPtr Create(RadioState radioState, bool anyConnected, int? percent)
    {
        ...
        using (var g = Graphics.FromImage(bitmap))
        {
            ...
            var radioOn = radioState == RadioState.On;
        ...
        // GetHicon allocates a native icon the runtime will not free; ownership passes to the caller.
